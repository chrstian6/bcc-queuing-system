...
export default function HeroSection({
  ...
  // Split words and apply special styling to "BCC Cares"
  const words = tagline.split(" ");

  // Custom render function to apply Fraunces font to "BCC Cares"
  ...
  return (
    <div
      className={`${inter.variable} ${fraunces.variable} relative overflow-hidden text-white min-h-[440px] md:min-h-[520px] flex items-center`}
    >
      ...
      <div className="relative z-10 px-6 md:px-10 py-14 pb-20 max-w-4xl">
        ...
        {/* Tagline with staggered word animation - Fraunces for BCC Cares */}
        <h1
          ref={wordsRef}
